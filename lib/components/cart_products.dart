    ...
    return new ListView.builder(
        ...
        itemBuilder: (context, index) {
          return Single_cart_product(
            ...
            cart_prod_product: Products_on_the_cart[index]["product"],
...
//                ===== This section is for the product color which is product product
                new Padding(
                ...
                Padding(
                  padding: const EdgeInsets.all(4.0),
                  child: new Text(cart_prod_product,
                      style: TextStyle(color: Colors.red)),
                ),
              ],
            ),
